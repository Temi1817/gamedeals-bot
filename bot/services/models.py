...
class PricePoint:
    ...
    `rebuilt` — цена не наблюдалась, а посчитана от нынешней регулярной
    цены магазина и процента скидки. Для Казахстана это заметно ближе к
    правде, чем пересчёт долларов по курсу: ту же распродажу −60% ITAD
    оценивал в 10 923 ₸, а в Epic она стоила 9 400 ₸.
    """
